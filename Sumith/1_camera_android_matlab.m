...
%---If you will use public Wi-Fi connection when you will connect VPN with your mobile or computer for security purpose
...
%--If the entered url is correct the variabe x is not false it means x get some value
